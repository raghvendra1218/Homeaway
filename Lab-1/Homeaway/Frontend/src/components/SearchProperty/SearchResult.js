                        ...
                        <div data-wdio="ScrollListener">
                            <div className="HitCollection" data-wdio="HitCollection">
                                ...
                                <div className="Hit media-flex media-flex--left media-flex--xs" data-wdio="hit">
                                    ...
                                    <div className="Hit__info"><a className="a--plain-link Hit__infoLink" href="/vacation-rental/p455355vb">
                                        <div className="HitInfo HitInfo--desktop">
                                            <div className="HitInfo__content">
                                                ...
                                                <h4 className="HitInfo__headline hover-text hidden-xs" href="/vacation-rental/p455355vb">Studio~Centrally
                                            Located~Trolley ~Convention Cntr /Bay/Gaslamp/Petco Park Etc.</h4>
                                                ...
                                                <div className="HitInfo__details">
                                                    <div className="Details__propertyType Details__item">Bungalow</div>
                                                    <div className="Details__bathrooms text-capitalize Details__label">1
                                            BA</div>
                                                    <div className="Details__sleeps Details__label">Sleeps 2</div>
                                                ...
                                                <div className="HitInfo__priceSuperlativeGroup"><span className="HitInfo__superlative small"><strong>Wonderful!</strong>
                                                    ...
                                                    <div className="HitInfo__price"><span className="InstantBook__icon" aria-hidden="true"
                                                        title="Book without waiting for owner approval"><span>
                                                            ...
                                                            data-wdio="Price" data-price="89">$&nbsp;89</span><span className="Price__period">avg/night</span></span></div>
                                                </div>
